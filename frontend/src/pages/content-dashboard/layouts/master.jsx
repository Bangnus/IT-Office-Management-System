...
import { fetchCurrentUser } from '../../../slicers/authenticateSlicer';
...
const DashMasterLayout = ({ children, title, path }) => {
    ...
    useEffect(() => {
        ...
        if (!currentUser && token) fecthcurrenagent();

        setCurrentAgent(currentUser?.data);
    ...
    }, [dispatch, currentUser, currentAgent, avatar]);
